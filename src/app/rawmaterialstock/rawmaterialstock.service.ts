...
export class RawMaterialStockService
{
   ...
   public updateProcessDate(rawid:number,rawdate:String) : any
   {
      ...
      return this.httpClient.put<any>('http://localhost:8015/rawmaterial/updateProcessDate',this.rms);
   }
   public updateStock(rawid:number,mandate:String,exitdate:String) : any
   {
      ...
      return this.httpClient.put<any>('http://localhost:8015/rawmaterial/updateStock',this.rms);
   }
